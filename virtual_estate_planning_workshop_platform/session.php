...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql="INSERT INTO session(workshop_id,topic,description,duration) VALUES('$workshop_id','$topic','$description','$duration')";
...
?>
                ...
                <input type="text" name="topic" required class="input"><br>
